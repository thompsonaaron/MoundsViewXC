  ...
  return (
    <div class={"flex flex-col my-4 md:my-0"}>
      <div class="flex relative cursor-pointer m-0 p-0 items-center text-gray-500 hover:text-black active:text-black">
        <span class="mx-4 md:mx-6 z-50" onClick={() => setIsOpen((prevValue) => !prevValue)}>
          MEDIA
          <svg
            viewBox="0 0 24 24"
            fill="none"
      ...
      <div class="relative text-left left-2">
        <ul
          class={clsx(
            ...
            {
              "static flex z-100 bg-none opacity-100 z-50 pointer-events-auto": isOpen,
        ...
        >
          <li class="pl-1 text-gray-500 hover:text-black">
            <a href="http://moundsviewboyscrosscountry.shutterfly.com/" target="_blank">
              XC Photos
            </a>
          </li>
          <li class="pl-1 text-gray-500 hover:text-black">
            <a href="https://moundsviewboystrack2017.shutterfly.com/#" target="_blank">
              TF Photos
            </a>
          </li>
          <li class="pl-1 text-gray-500 hover:text-black">
