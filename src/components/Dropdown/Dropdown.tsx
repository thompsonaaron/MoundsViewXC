				...
				<span
					...
					<svg
						...
						<g id="SVGRepo_iconCarrier">
							<path
								fill="currentColor"
								d="M5.16108 10.0731C4.45387 9.2649 5.02785 8 6.1018 8H17.898C18.972 8 19.5459 9.2649 18.8388 10.0731L13.3169 16.3838C12.6197 17.1806 11.3801 17.1806 10.6829 16.3838L5.16108 10.0731ZM6.65274 9.5L11.8118 15.396C11.9114 15.5099 12.0885 15.5099 12.1881 15.396L17.3471 9.5H6.65274Z"></path>
						</g>
					</svg>
				</span>
			</div>
				...
				<ul
					class={clsx(
						"absolute m-0 bg-white w-full px-4 py-2 -top-24 md:-top-8 left-12 md:right-0 flex flex-col transition-all duration-1000 ease-in-out",
						{
							...
							"duration-1000 ease-in-out translate-x-0 md:translate-y-0 opacity-0 z-0":
								!isOpen,
						}
					)}>
